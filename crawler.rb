class ProfileCrawler
  def self.crawl(url)
    begin
      ...
      profile = Profile.new(title, rate_count, instructor_name, instructor_bio, twitter, facebook, google, youtube, linkedin, website)
      return profile
    rescue
      return nil
    end
...
class Profile
  attr_accessor :title, :rate_count, :instructor_name, :instructor_bio, :twitter, :facebook, :google, :youtube, :linkedin, :website
  def initialize(title, rate_count, instructor_name, instructor_bio, twitter, facebook, google, youtube, linkedin, website)
    @title = title
